          ...
          <div>
            ...
            {isMobile ? (
              ...
              <button
                ...
                // onClick={() => openModal()}
              >
                <span className="me-1">+</span> My teams
              </button>
            )}
          </div>
        </div>
        ...
        <>
          ...
          >
           ...
           Role
              ...
              <div
                className="col-2 columnName "
                style={{ paddingTop: "8px", paddingBottom: "12px" , paddingLeft:"6.5vw" }}
              >
             Manger
              </div>
            ...
            <div style={{ minWidth: "1000px" }}>
              <div className="row bg-white mt-3  roleData">
                <div className="col-3">
                  <input
