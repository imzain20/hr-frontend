...
const startDate = new Date(); // Define startDate with actual date value
const endDate = new Date(); // Define endDate with actual date value

const RequestTimeoff = ({ isOpen, onClose }: modalUsageProps) => {

    const [eventsData, setEventsData] = useState(events);

    const handlesave = ({ start, end }: { start: Date, end: Date }) => {
        const newEvent = {
            id: 0, 
            title: "New Event", // Example title for the new event
            start: start,
            end: end,
            status: "pending", // Example status for the new event
                            ...
                            <div className="container">
                                ...
                                <div className="btnSpace">
                                    ...
                                    <button
                                        ...
                                        onClick={() => handlesave({ start: startDate, end: endDate })}
                                    >
                                        Request
                                    </button>
                                </div>
