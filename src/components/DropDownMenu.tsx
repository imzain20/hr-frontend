...
const DropDownMenu = ({
  ...
  return (
    <div className="dropdown-center d-md-block d-none">
      <img
        src={mainAvatar}
        alt="profile pic"
      ...
      >
        <li className="d-flex gap-2 mb-2">
          ...
          <div className="d-flex flex-column">
            ...
            <span style={{ color: "#828282" }}>{userState?.user?.Email}</span>
          </div>
        </li>
        <li>
          <hr
          ...
          {businesses.map((business, i) => (
            ...
            >
              <input
                ...
                value={business._id}
                checked={businessId === business._id}
